...
def startDesEncryption(pt,key):
    ...
    print("The Key: ",key)
    pt = str2hex(pt)
    print("The plain text in hexadecimal: ",pt)
    ...
    for i in range(0,cyc):
        ...
        print("Start new cycle:",pt)
        # Table of Position of 64 bits at initial level: Initial Permutation Table
        global initial_perm,exp_d,per,sbox,final_perm
        ...
        rk = []
        for i in range(0, 16):
       # Assuming there's a loop iterating through shift_table indices
