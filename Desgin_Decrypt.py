...
def startDesDecryption(pt,key):
    ...
    for i in range(0,cyc):
        ...
        rkb_rev = rkb[::-1]
        rk_rev = rk[::-1]
        text = bin2hex(encrypt(pt, rkb_rev, rk_rev))
...
#pt = "D1A87D37F5B6BFE1BDD5E90D454BF10A"
#key = "AABB09182736CCDD"
#key = secrets.token_hex(8).upper()
#cipher = startDesDecryption(pt,key)  
#print("The Plain Text: ",cipher)
